...
class _EventsViewState extends State<EventsView> {
  ...
  List<ChatGroupModel> chatGroupsList = [
    ChatGroupModel("Blood Requirement", Icons.bloodtype),
    ChatGroupModel("Committee", Icons.group),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: chatGroupsList.length,
        itemBuilder: (ctx, i){
          return Padding(
            ...
            child: ListTile(
              ...
              leading: Icon(chatGroupsList[i].icon),
              title: Text(
                chatGroupsList[i].name,
                style: TextStyle(
                  color: Colors.black,
                ),
              ),
...
class ChatGroupModel{
  ChatGroupModel(this.name, this.icon);
